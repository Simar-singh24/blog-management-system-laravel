                ...
                <div class="topbar">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <small class="text-muted">Update your article</small>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @if($blog->image)
                                            <img src="{{ asset(str_starts_with($blog->image, 'images/') ? $blog->image : 'images/' . $blog->image) }}" class="image-preview" id="imagePreview">
                                        @else
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="short_description" class="form-control @error('short_description') is-invalid @enderror" rows="2" required>{{ old('short_description', $blog->short_description) }}</textarea>
                                    @error('short_description') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Full Content <span class="text-danger">*</span></label>
                                    <textarea id="content" name="content" class="@error('content') is-invalid @enderror" required>{{ old('content', $blog->content) }}</textarea>
